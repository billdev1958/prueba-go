    ...
    "paths": {
        ...
        "/comercios": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.ComercioResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Commerce to create",
                        "name": "comercio",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateComercioRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/comercios/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated commerce data",
                        "name": "comercio",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateComercioRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.EarningsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        "common.ErrorResponse": {
            ...
            "properties": {
                "error": {
                    "type": "string",
                    "example": "información del error aquí"
                }
            }
        },
        ...
        "models.ComercioResponse": {
            ...
            "properties": {
                ...
                "name": {
                    "type": "string",
                    "example": "Abarrotes Doña María"
                }
            }
        },
        "models.CreateComercioRequest": {
            "type": "object",
            "required": [
                "comission_rate",
                "name"
        ...
        "models.UpdateComercioRequest": {
            ...
            "properties": {
                ...
                "name": {
                    "type": "string",
                    "example": "Abarrotes Doña María Sucursal 2"
                }
            }
        }
    },
